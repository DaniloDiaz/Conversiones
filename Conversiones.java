 ...
 */
public class Ejercicio2_Conversiones {
        ...
        do{
            ...
            switch (opcion){
                ...
                case 2:
                    ...
                    for (int i = 1; i <= valor; i++) {
                        System.out.printf("%.2f\t\t%.2f\t\t%.2f\t\t%.2f\n",(double)i,calcular_Pulgadas_a_Metros((double)i),
                                calcular_Pies_a_Yardas(calcular_Pulgadas_a_Pies((double)i)),calcular_Pulgadas_a_Pies((double)i));                      
                    }                    
                    break;
                case 3:
                    Ingresar_Valores();
